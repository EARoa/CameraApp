...
class ViewController: UIViewController,UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    @IBAction func saveImageButton(){
        ...
        let alert: UIAlertController = UIAlertController(title: "Hey!", message: "Your image has been saved 🎉", preferredStyle: .Alert)
        alert.addAction(UIAlertAction(title: "COOL", style: .Default, handler: {(action: UIAlertAction) -> Void in
        }))
